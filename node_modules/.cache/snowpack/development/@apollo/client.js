...
import { r as react } from '../common/index-b6589ed0.js';
...
export { ApolloCache, ApolloClient, ApolloConsumer, ApolloError, ApolloLink, ApolloProvider, Cache$1 as Cache, DocumentType, HttpLink, InMemoryCache, MissingFieldError, NetworkStatus, zenObservable as Observable, ObservableQuery, checkFetcher, concat, createHttpLink, createSignalIfSupported, defaultDataIdFromObject, disableExperimentalFragmentVariables$1 as disableExperimentalFragmentVariables, disableFragmentWarnings$1 as disableFragmentWarnings, empty, enableExperimentalFragmentVariables$1 as enableExperimentalFragmentVariables, execute, fallbackHttpConfig, from, fromError, fromPromise, getApolloContext, src as gql, isApolloError, isReference, makeReference, makeVar, mergeOptions, operationName, parseAndCheckHttpResponse, parser$2 as parser, getApolloContext as resetApolloContext, resetCaches$1 as resetCaches, rewriteURIForGET, selectHttpOptionsAndBody, selectURI, serializeFetchParameter, setVerbosity as setLogVerbosity, split, throwServerError, toPromise, useApolloClient, useLazyQuery, useMutation, useQuery, useReactiveVar, useSubscription };
